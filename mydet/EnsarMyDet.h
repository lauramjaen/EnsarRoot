...
class EnsarMyDet : public EnsarDetector
{
 ...
 public:
   ...
   **/
  EnsarMyDet(const char* name, Bool_t active);
...
//  void SaveGeoParams();
  ...
  private:
    ...
    ClassDef(EnsarMyDet,1);
};


inline void EnsarMyDet::ResetParameters() {
