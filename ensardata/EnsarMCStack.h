// -------------------------------------------------------------------------
// -----                   EnsarMCStack header file                    -----
// -----           Created 10/08/04  by D. Bertini / V. Friese         -----
// -----           Adapted 11/09/12  by P. Cabanelas for ENSAR         -----
// -------------------------------------------------------------------------
 ...
 ** are copied to a EnsarMCTrack array, which is stored in the output.
 **
...
#ifndef ENSARMCSTACK_H
#define ENSARMCSTACK_H
...
class EnsarMCStack : public FairGenericStack
{
 ...
 public:
   ...
   **/
  EnsarMCStack(Int_t size = 100);


  /** Destructor  **/
  virtual ~EnsarMCStack();
 ...
 private:
  ...
  /** Array of EnsarMCTracks containg the tracks written to the output **/
