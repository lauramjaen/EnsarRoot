...
EnsarMCTrack::EnsarMCTrack(Int_t pdgCode, Int_t motherId, Double_t px,
...
// -----   Copy constructor   ----------------------------------------------
EnsarMCTrack::EnsarMCTrack(const EnsarMCTrack& track) { 
  *this = track;
}
// -------------------------------------------------------------------------
...
EnsarMCTrack::EnsarMCTrack(TParticle* part, Int_t fMC) {
...
// -----   Public method Print   -------------------------------------------
void EnsarMCTrack::Print(Int_t trackId) const {
...
Double_t EnsarMCTrack::GetMass() const {
...
Double_t EnsarMCTrack::GetRapidity() const {
...
Int_t EnsarMCTrack::GetNPoints(DetectorId detId) const {
  if      ( detId == kMYDET  ) return (  fNPoints &   1);
  else {
    cout << "-E- EnsarMCTrack::GetNPoints: Unknown detector ID "
	 << detId << endl;
    return 0;
  }
}
...
void EnsarMCTrack::SetNPoints(Int_t iDet, Int_t nPoints) {
...
======================================================================= */
  ...
  else cout << "-E- EnsarMCTrack::SetNPoints: Unknown detector ID "
	    << iDet << endl;
