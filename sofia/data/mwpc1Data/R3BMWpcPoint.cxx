...
R3BMWpcPoint::R3BMWpcPoint(Int_t trackID, Int_t detID, Int_t volid, Int_t copy, Int_t ident,
...
void R3BMWpcPoint::Print(const Option_t* opt) const {
  cout << "-I- R3BMWpcPoint: STS Point for track " << fTrackID 
