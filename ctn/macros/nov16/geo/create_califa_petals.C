...
//TGeoCombiTrans matDemo_5(0., 0., 0., new TGeoRotation("rotDemo_5", 0., 0., 0.));              //posicion original
//TGeoCombiTrans matDemo_5(-3.5, 0., -10., new TGeoRotation("rotDemo_5", -30., 0., 0.));        //mismo plano
//TGeoCombiTrans matDemo_5(-3.5, 0., -32., new TGeoRotation("rotDemo_5", -30., 25., 0.));       //mismo plano rotado MAL
//TGeoCombiTrans matDemo_5(29.5, 9.09, 24.25, new TGeoRotation("rotDemo_5", 0., 0., 0.));       //translaciones bien en teoria -30, 0., 0.
//TGeoCombiTrans matDemo_5(29.5, 0., 0., new TGeoRotation("rotDemo_5", 0., 0., 0.));            //translaciones bien en teoria -30, 0., 0.
//TGeoCombiTrans matDemo_5(9.09, 24.25, 29.5 , new TGeoRotation("rotDemo_5", -30., 0., 0.));    //cambio de coord (x,y,z)->(z,x,y)
//TGeoCombiTrans matDemo_5(-3.5, 0., -10., new TGeoRotation("rotDemo_5", -120., 180., 90.));	//orientaciones de angulos si + trans no
//TGeoCombiTrans matDemo_5(-3.5, 0., -10., new TGeoRotation("rotDemo_5", -120., 180., 90.));	//orientaciones de angulos si+ rotado no + trans no  
//-----
//TGeoCombiTrans matDemo_5(-56.09, -37., -27., new TGeoRotation("rotDemo_5", -90., 190., 0.));         //translacion t_5 bien + rotacion bien ->resultado final mal
//TGeoCombiTrans matDemo_5(-17.78, 3., 19., new TGeoRotation("rotDemo_5", -90., 190., 0.));         //translacion adecuada para la rot + rotacion bien ->resultado final bien
TGeoCombiTrans matDemo_5(-17.78, 3., -5., new TGeoRotation("rotDemo_5", -90., 150., 0.));         //translacion adecuada para la rot + rotacion bien ->resultado final bien

//TGeoCombiTrans matDemo_6(0., 0., 0., new TGeoRotation("rotDemo_6", 0., 0., 0.));              //posicion original
//TGeoCombiTrans matDemo_6(-16.5, 25., -3., new TGeoRotation("rotDemo_6", 28., 90., 0.));       //mismo plano
//TGeoCombiTrans matDemo_6(-16.5, 25., -3., new TGeoRotation("rotDemo_6", 28., 115., 0.));      //mismo plano rotado del reves (theta+25º) MAL
//TGeoCombiTrans matDemo_6(-22.19, -42., -24.25, new TGeoRotation("rotDemo_6", 0., 0., 0.));    //translaciones bien en teoria 30., 90., 0.
//TGeoCombiTrans matDemo_6(-22.19, 0., 0., new TGeoRotation("rotDemo_6", 0., 0., 0.));          //translaciones bien en teoria 30., 90., 0.
//TGeoCombiTrans matDemo_6( -42., -24.25, -22.19, new TGeoRotation("rotDemo_6", 30., 90., 0.)); //cambio de coord (x,y,z)->(z,x,y)
//TGeoCombiTrans matDemo_6(-16.5, 25., -3., new TGeoRotation("rotDemo_6", 210., 90., 0.));	//orientaciones de angulos correctas las trans no
//TGeoCombiTrans matDemo_6(-16.5, 25., -3., new TGeoRotation("rotDemo_6", 210., 65., 0.));	//orientaciones de angulos si+ rotado si (theta-25º) + trans no
//----
//TGeoCombiTrans matDemo_6(-5., -37., 24.69, new TGeoRotation("rotDemo_6", 270., 65., 0.));          //translacion t_6 + rotacion bien ->resultado final mal
TGeoCombiTrans matDemo_6(-3., 3., 6.38, new TGeoRotation("rotDemo_6", 270., 65., 0.));          //translacion adecuada para la rot + rotacion bien ->resultado final bien
