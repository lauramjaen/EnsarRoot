...
void ConstructGeometry(TGeoMedium *pMedVac, TGeoMedium *pMedH2O, TGeoMedium *pMedAir, TGeoMedium *pMedSteel, TGeoMedium *pMedAl, TGeoMedium *pMedAcrylic)
{
  ...
  pWorld->AddNode(sphere_in,7,comb_7); 
	...
	//Source layer "Al"
	TGeoVolume *source_layer = gGeoManager->MakeBox("Source_layer", pMedAl,3.975,3.975,0.5);
  ...
  // ----------------------------------------------
	...
	first_acry_layer->SetFillColor(5);
  first_acry_layer->SetLineColor(5);
  ...
  first_acry_layer->SetVisLeaves(kTRUE);
	...
	other_acry_layer->SetFillColor(5);
  other_acry_layer->SetLineColor(5);
  ...
  // ----------------------------------------------
	...
	//Metal support
	TGeoVolume *metal_support = gGeoManager->MakeBox("Support", pMedSteel,20.,20.,16.5);
	metal_support->SetFillColor(40);
  metal_support->SetLineColor(40);
  metal_support->SetTransparency(70);
  metal_support->SetVisLeaves(kTRUE);

  TGeoCombiTrans *comb_14 = new TGeoCombiTrans("comb_14",0.,0.,81.5,rot);
