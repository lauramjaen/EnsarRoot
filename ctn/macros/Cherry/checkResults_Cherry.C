...
void checkResults_Cherry() {
  ...
  TH1F *hydif = new TH1F("hydiff","hydiff",500,-100,100);
	...
	TH2F* hzx  = new TH2F("hzx","Depth Profiling", 200,-10,-18,200,-4,4);
	TH2F* hz_energy  = new TH2F("hz_energy","Energy Profiling in z axis", 200,-10,-18,1100,0,11);
	...
	TH3F* hxyz_energy = new TH3F("hxyz_energy","Collides 3D and Energy", 80,-4,4,80,-4,4,80,-10,-18);
