...
void simall_Cherry(Int_t nEvents = 1,
            TMap* fDetList = NULL,
            Bool_t fVis = kFALSE,
            TString fMC = "TGeant3",
            ...
            TString InFile = "evt_gen.dat")
{
  ...
  if ( (fUserPList  == kTRUE ) &&
       ...
       run->SetUserConfig("g4Config.C");//g4Config.C
  ...
  Int_t pdgId          = 11;            // geant particle id of the electron beam(11), photons (22), protons (2212)
  Double32_t theta1    = 0.;            // polar angle distribution (degrees)
  Double32_t theta2    = 0.;						//2º for one Cherry & 6º for 7 Cherries
  Double32_t momentum  = 0.01049;      // GeV/c 6048keV energy of the beam
