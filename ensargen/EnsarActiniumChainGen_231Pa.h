// *********************************************************************
// *****   
// *****             EnsarActiniumChainGen_231Pa header file         
// ***** 		     
// *****  	The generator creates the 231Pa->alpha + 227Ac* and 
// ***** 		227Ac*->227Ac+gamma reactions
...
#ifndef ENSAR_ACTINIUMCHAIN_231PA_H
#define ENSAR_ACTINIUMCHAIN_231PA_H
...
class EnsarActiniumChainGen_231Pa : public FairGenerator
{
  public:

    /** Default constructor. **/
    EnsarActiniumChainGen_231Pa();

    /** Constructor.  **/
    EnsarActiniumChainGen_231Pa(const char* inputFile);

    /** Destructor. **/
    virtual ~EnsarActiniumChainGen_231Pa();
 ...
 private:
    ...
    ClassDef(EnsarActiniumChainGen_231Pa,1);
    void CloseInput();
    void ReadParameters();
