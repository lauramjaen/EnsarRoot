// *********************************************************************
// *****   
// *****             EnsarActiniumChainGen_211Pb header file         
// ***** 		     
// *****  	The generator creates the 211Pb->alpha + 211Bi* and 
// ***** 		211Bi*->211Bi+gamma reactions
...
#ifndef ENSAR_ACTINIUMCHAIN_211Pb_H
#define ENSAR_ACTINIUMCHAIN_211Pb_H
...
class EnsarActiniumChainGen_211Pb : public FairGenerator
{
  public:

    /** Default constructor. **/
    EnsarActiniumChainGen_211Pb();

    /** Constructor.  **/
    EnsarActiniumChainGen_211Pb(const char* inputFile);

    /** Destructor. **/
    virtual ~EnsarActiniumChainGen_211Pb();
 ...
 private:
    ...
    ClassDef(EnsarActiniumChainGen_211Pb,1);
    void CloseInput();
    void ReadParameters();
