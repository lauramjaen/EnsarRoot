// *********************************************************************
// *****   
// *****             EnsarThoriumChainGen_224Ra header file         
// ***** 		     
// *****  	The generator creates the 224Ra->alpha + 224Ra* and 
// ***** 		224Ra*->224Ra+gamma reactions
...
#ifndef ENSAR_THORIUMCHAIN_224RA_H
#define ENSAR_THORIUMCHAIN_224RA_H
...
class EnsarThoriumChainGen_224Ra : public FairGenerator
{
  public:

    /** Default constructor. **/
    EnsarThoriumChainGen_224Ra();

    /** Constructor.  **/
    EnsarThoriumChainGen_224Ra(const char* inputFile);

    /** Destructor. **/
    virtual ~EnsarThoriumChainGen_224Ra();
 ...
 private:
    ...
    ClassDef(EnsarThoriumChainGen_224Ra,1);
    void CloseInput();
    void ReadParameters();
