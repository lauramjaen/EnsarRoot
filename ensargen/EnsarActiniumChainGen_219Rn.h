// *********************************************************************
// *****   
// *****             EnsarActiniumChainGen_219Rn header file         
// ***** 		     
// *****  	The generator creates the 219Rn->alpha + 215Po* and 
// ***** 		215Po*->215Po+gamma reactions
...
#ifndef ENSAR_ACTINIUMCHAIN_219RN_H
#define ENSAR_ACTINIUMCHAIN_219RN_H
...
class EnsarActiniumChainGen_219Rn : public FairGenerator
{
  public:

    /** Default constructor. **/
    EnsarActiniumChainGen_219Rn();

    /** Constructor.  **/
    EnsarActiniumChainGen_219Rn(const char* inputFile);

    /** Destructor. **/
    virtual ~EnsarActiniumChainGen_219Rn();
 ...
 private:
    ...
    ClassDef(EnsarActiniumChainGen_219Rn,1);
    void CloseInput();
    void ReadParameters();
