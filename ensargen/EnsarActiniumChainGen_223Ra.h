// *********************************************************************
// *****   
// *****             EnsarActiniumChainGen_223Ra header file         
// ***** 		     
// *****  	The generator creates the 223Ra->alpha + 219Rn* and 
// ***** 		219Rn*->219Rn+gamma reactions
...
#ifndef ENSAR_ACTINIUMCHAIN_223RA_H
#define ENSAR_ACTINIUMCHAIN_223RA_H
...
class EnsarActiniumChainGen_223Ra : public FairGenerator
{
  public:

    /** Default constructor. **/
    EnsarActiniumChainGen_223Ra();

    /** Constructor.  **/
    EnsarActiniumChainGen_223Ra(const char* inputFile);

    /** Destructor. **/
    virtual ~EnsarActiniumChainGen_223Ra();
 ...
 private:
    ...
    ClassDef(EnsarActiniumChainGen_223Ra,1);
    void CloseInput();
    void ReadParameters();
