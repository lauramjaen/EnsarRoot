// *********************************************************************
// *****   
// *****             EnsarThoriumChainGen_224Ra source file                                   
// *****   							
// *********************************************************************

#include "EnsarThoriumChainGen_224Ra.h"
...
// -----   Default constructor   ------------------------------------------
EnsarThoriumChainGen_224Ra::EnsarThoriumChainGen_224Ra()  :
  FairGenerator(),
...
EnsarThoriumChainGen_224Ra::EnsarThoriumChainGen_224Ra(const char* inputFile) :
  FairGenerator(),
	fPointVtxIsSet(0), fBoxVtxIsSet(0),
  fThetaRangeIsSet(0), fPhiRangeIsSet(0),
	fX(0), fY(0), fZ(0),
	...
	fPhiMin(0), fPhiMax(0)
{
  ...
  cout << "-I- EnsarThoriumChainGen_224Ra: Opening input file " << inputFile << endl;
  fFileName  = inputFile;
  
  fInputFile = new ifstream(fFileName);
  if ( ! fInputFile->is_open() ) Fatal("EnsarThoriumChainGen_224Ra","Cannot open input file.");
...
Bool_t  EnsarThoriumChainGen_224Ra::Init()
{
		
	if (fPointVtxIsSet && fBoxVtxIsSet) {
    Fatal("Init()","EnsarThoriumChainGen_224Ra: Cannot set point and box vertices simultaneously");
  }
...
// -----   Read events   --------------------------------------------------
Bool_t EnsarThoriumChainGen_224Ra::ReadEvent(FairPrimaryGenerator* primGen)
{
  
  
  //----- Check for input file -----
  if ( ! fInputFile->is_open() ) {
    cout << "-E- EnsarThoriumChainGen_224Ra: Input file not open!" << endl;
    return kFALSE;
  }
	...
	Probability_emmittedParticles [0]=0.9492;
	Probability_emmittedParticles [1]=0.0506;
...
void EnsarThoriumChainGen_224Ra::CloseInput() {
  if ( fInputFile ) {
    if ( fInputFile->is_open() ) {
      cout << "-I- EnsarThoriumChainGen_224Ra: Closing input file " 
	   << fFileName << endl;
      fInputFile->close();
    }
    delete fInputFile;
...
// ---Read Parameters File --------------------------------------------
void EnsarThoriumChainGen_224Ra::ReadParameters() {

}

// --- De-excitation Process --------------------------------------------
TArrayF* EnsarThoriumChainGen_224Ra::Deexcitation(Int_t InicialState, Int_t & FinalState) {
	...
	if (InicialState==1){numGammas=1;}
		...
		cout << "-E- EnsarThoriumChainGen_224Ra: Incorrect final state!" << endl;
	}
...
void EnsarThoriumChainGen_224Ra::TrackMomentum( Double_t Energy, Double_t & Px, Double_t & Py, Double_t & Pz ) {
...
ClassImp(EnsarThoriumChainGen_224Ra)
