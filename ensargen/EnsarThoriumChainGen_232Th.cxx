// *********************************************************************
// *****   
// *****             EnsarThoriumChainGen_232Th source file                                   
// *****   							
// *********************************************************************

#include "EnsarThoriumChainGen_232Th.h"
...
// -----   Default constructor   ------------------------------------------
EnsarThoriumChainGen_232Th::EnsarThoriumChainGen_232Th()  :
  FairGenerator(),
...
EnsarThoriumChainGen_232Th::EnsarThoriumChainGen_232Th(const char* inputFile) :
  FairGenerator(),
	fPointVtxIsSet(0), fBoxVtxIsSet(0),
  fThetaRangeIsSet(0), fPhiRangeIsSet(0),
	fX(0), fY(0), fZ(0),
	...
	fPhiMin(0), fPhiMax(0)
{
  ...
  cout << "-I- EnsarThoriumChainGen_232Th: Opening input file " << inputFile << endl;
  fFileName  = inputFile;
  
  fInputFile = new ifstream(fFileName);
  if ( ! fInputFile->is_open() ) Fatal("EnsarThoriumChainGen_232Th","Cannot open input file.");
...
Bool_t  EnsarThoriumChainGen_232Th::Init()
{
		
	if (fPointVtxIsSet && fBoxVtxIsSet) {
    Fatal("Init()","EnsarThoriumChainGen_232Th: Cannot set point and box vertices simultaneously");
  }
...
// -----   Read events   --------------------------------------------------
Bool_t EnsarThoriumChainGen_232Th::ReadEvent(FairPrimaryGenerator* primGen)
{
  
  
  //----- Check for input file -----
  if ( ! fInputFile->is_open() ) {
    cout << "-E- EnsarThoriumChainGen_232Th: Input file not open!" << endl;
    return kFALSE;
  }
	...
	Probability_emmittedParticles [0]=0.782;
	Probability_emmittedParticles [1]=0.217;
...
void EnsarThoriumChainGen_232Th::CloseInput() {
  if ( fInputFile ) {
    if ( fInputFile->is_open() ) {
      cout << "-I- EnsarThoriumChainGen_232Th: Closing input file " 
	   << fFileName << endl;
      fInputFile->close();
    }
    delete fInputFile;
...
// ---Read Parameters File --------------------------------------------
void EnsarThoriumChainGen_232Th::ReadParameters() {

}

// --- De-excitation Process --------------------------------------------
TArrayF* EnsarThoriumChainGen_232Th::Deexcitation(Int_t InicialState, Int_t & FinalState) {
	...
	if (InicialState==1){numGammas=1;}
		...
		cout << "-E- EnsarThoriumChainGen_232Th: Incorrect final state!" << endl;
	}
...
void EnsarThoriumChainGen_232Th::TrackMomentum( Double_t Energy, Double_t & Px, Double_t & Py, Double_t & Pz ) {
...
ClassImp(EnsarThoriumChainGen_232Th)
