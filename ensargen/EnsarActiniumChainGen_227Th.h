// *********************************************************************
// *****   
// *****             EnsarActiniumChainGen_227Th header file         
// ***** 		     
// *****  	The generator creates the 227Th->alpha + 223Ra* and 
// ***** 		223Ra*->223Ra+gamma reactions
...
#ifndef ENSAR_ACTINIUMCHAIN_227TH_H
#define ENSAR_ACTINIUMCHAIN_227TH_H
...
class EnsarActiniumChainGen_227Th : public FairGenerator
{
  public:

    /** Default constructor. **/
    EnsarActiniumChainGen_227Th();

    /** Constructor.  **/
    EnsarActiniumChainGen_227Th(const char* inputFile);

    /** Destructor. **/
    virtual ~EnsarActiniumChainGen_227Th();
 ...
 private:
    ...
    ClassDef(EnsarActiniumChainGen_227Th,1);
    void CloseInput();
    void ReadParameters();
