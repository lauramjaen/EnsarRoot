// *********************************************************************
// *****   
// *****             EnsarActiniumChainGen_227Ac header file         
// ***** 		     
// *****  	The generator creates the 227Ac decay
// *****      98,62%: 227Ac->beta + 227Th* & 227Th*->227Th+gamma
// ***** 	 		1.38% : 227Ac->alpha + 223Fr* & 223Fr*->223Fr+gamma
// *****    but the alpha decay has an I<1% so we don't include it.
// *****
// ***** 		from the Actinium Chain of natural background	
// ***** 	
...
#ifndef ENSAR_ACTINIUMCHAIN_227AC_H
#define ENSAR_ACTINIUMCHAIN_227AC_H
...
class EnsarActiniumChainGen_227Ac : public FairGenerator
{
  public:

    /** Default constructor. **/
    EnsarActiniumChainGen_227Ac();

    /** Constructor.  **/
    EnsarActiniumChainGen_227Ac(const char* inputFile);

    /** Destructor. **/
    virtual ~EnsarActiniumChainGen_227Ac();
 ...
 private:
    ...
    ClassDef(EnsarActiniumChainGen_227Ac,1);
    void CloseInput();
    void ReadParameters();
