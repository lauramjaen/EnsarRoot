// *********************************************************************
// *****   
// *****             EnsarUraniumChainGen_230Th header file         
// ***** 		     
// *****  	The generator creates the 230Th->alpha + 226Ra* and 
// ***** 		226Ra*->226Ra+gamma reactions
...
#ifndef ENSAR_URANIUMCHAIN_230TH_H
#define ENSAR_URANIUMCHAIN_230TH_H
...
class EnsarUraniumChainGen_230Th : public FairGenerator
{
  public:

    /** Default constructor. **/
    EnsarUraniumChainGen_230Th();

    /** Constructor.  **/
    EnsarUraniumChainGen_230Th(const char* inputFile);

    /** Destructor. **/
    virtual ~EnsarUraniumChainGen_230Th();
 ...
 private:
    ...
    ClassDef(EnsarUraniumChainGen_230Th,1);
    void CloseInput();
    void ReadParameters();
