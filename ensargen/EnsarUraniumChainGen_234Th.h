// *********************************************************************
// *****   
// *****             EnsarUraniumChainGen_234Th header file         
// ***** 		     
// *****  	The generator creates the 234Th->beta + 234Pa* and 
// ***** 		234Pa*->234Pa+gamma reactions
...
#ifndef ENSAR_URANIUMCHAIN_234TH_H
#define ENSAR_URANIUMCHAIN_234TH_H
...
class EnsarUraniumChainGen_234Th : public FairGenerator
{
  public:

    /** Default constructor. **/
    EnsarUraniumChainGen_234Th();

    /** Constructor.  **/
    EnsarUraniumChainGen_234Th(const char* inputFile);

    /** Destructor. **/
    virtual ~EnsarUraniumChainGen_234Th();
 ...
 private:
    ...
    ClassDef(EnsarUraniumChainGen_234Th,1);
    void CloseInput();
    void ReadParameters();
