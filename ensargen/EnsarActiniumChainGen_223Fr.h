// *********************************************************************
// *****   
// *****             EnsarActiniumChainGen_223Fr header file         
// ***** 		     
// *****  	The generator creates the 223Fr->beta + 223Ra* and 
...
#ifndef ENSAR_ACTINIUMCHAIN_223FR_H
#define ENSAR_ACTINIUMCHAIN_223FR_H
...
class EnsarActiniumChainGen_223Fr : public FairGenerator
{
  public:

    /** Default constructor. **/
    EnsarActiniumChainGen_223Fr();

    /** Constructor.  **/
    EnsarActiniumChainGen_223Fr(const char* inputFile);

    /** Destructor. **/
    virtual ~EnsarActiniumChainGen_223Fr();
 ...
 private:
    ...
    ClassDef(EnsarActiniumChainGen_223Fr,1);
    void CloseInput();
    void ReadParameters();
