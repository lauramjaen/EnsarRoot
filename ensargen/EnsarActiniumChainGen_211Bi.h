// *********************************************************************
// *****   
// *****             EnsarActiniumChainGen_211Bi header file         
// ***** 		     
// *****  	The generator creates the 211Bi->alpha + 207Tl* and 
// ***** 		207Tl*->207Tl+gamma reactions
...
#ifndef ENSAR_ACTINIUMCHAIN_211BI_H
#define ENSAR_ACTINIUMCHAIN_211BI_H
...
class EnsarActiniumChainGen_211Bi : public FairGenerator
{
  public:

    /** Default constructor. **/
    EnsarActiniumChainGen_211Bi();

    /** Constructor.  **/
    EnsarActiniumChainGen_211Bi(const char* inputFile);

    /** Destructor. **/
    virtual ~EnsarActiniumChainGen_211Bi();
 ...
 private:
    ...
    ClassDef(EnsarActiniumChainGen_211Bi,1);
    void CloseInput();
    void ReadParameters();
