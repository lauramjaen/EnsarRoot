// *********************************************************************
// *****   
// *****             EnsarThoriumChainGen_228Th header file         
// ***** 		     
// *****  	The generator creates the 228Th->alpha + 224Ra* and 
...
#ifndef ENSAR_THORIUMCHAIN_228TH_H
#define ENSAR_THORIUMCHAIN_228TH_H
...
class EnsarThoriumChainGen_228Th : public FairGenerator
{
  public:

    /** Default constructor. **/
    EnsarThoriumChainGen_228Th();

    /** Constructor.  **/
    EnsarThoriumChainGen_228Th(const char* inputFile);

    /** Destructor. **/
    virtual ~EnsarThoriumChainGen_228Th();
 ...
 private:
    ...
    ClassDef(EnsarThoriumChainGen_228Th,1);
    void CloseInput();
    void ReadParameters();
