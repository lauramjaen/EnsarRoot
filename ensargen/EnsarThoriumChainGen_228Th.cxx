// *********************************************************************
// *****   
// *****             EnsarThoriumChainGen_228Th source file                                   
// *****   							
// *********************************************************************

#include "EnsarThoriumChainGen_228Th.h"
...
// -----   Default constructor   ------------------------------------------
EnsarThoriumChainGen_228Th::EnsarThoriumChainGen_228Th()  :
  FairGenerator(),
...
EnsarThoriumChainGen_228Th::EnsarThoriumChainGen_228Th(const char* inputFile) :
  FairGenerator(),
	fPointVtxIsSet(0), fBoxVtxIsSet(0),
  fThetaRangeIsSet(0), fPhiRangeIsSet(0),
	fX(0), fY(0), fZ(0),
	...
	fPhiMin(0), fPhiMax(0)
{
  ...
  cout << "-I- EnsarThoriumChainGen_228Th: Opening input file " << inputFile << endl;
  fFileName  = inputFile;
  
  fInputFile = new ifstream(fFileName);
  if ( ! fInputFile->is_open() ) Fatal("EnsarThoriumChainGen_228Th","Cannot open input file.");
...
Bool_t  EnsarThoriumChainGen_228Th::Init()
{
		
	if (fPointVtxIsSet && fBoxVtxIsSet) {
    Fatal("Init()","EnsarThoriumChainGen_228Th: Cannot set point and box vertices simultaneously");
  }
...
// -----   Read events   --------------------------------------------------
Bool_t EnsarThoriumChainGen_228Th::ReadEvent(FairPrimaryGenerator* primGen)
{
  
  
  //----- Check for input file -----
  if ( ! fInputFile->is_open() ) {
    cout << "-E- EnsarThoriumChainGen_228Th: Input file not open!" << endl;
    return kFALSE;
  }
	...
	Probability_emmittedParticles [0]=0.734;
	Probability_emmittedParticles [1]=0.26;
...
void EnsarThoriumChainGen_228Th::CloseInput() {
  if ( fInputFile ) {
    if ( fInputFile->is_open() ) {
      cout << "-I- EnsarThoriumChainGen_228Th: Closing input file " 
	   << fFileName << endl;
      fInputFile->close();
    }
    delete fInputFile;
...
// ---Read Parameters File --------------------------------------------
void EnsarThoriumChainGen_228Th::ReadParameters() {

}

// --- De-excitation Process --------------------------------------------
TArrayF* EnsarThoriumChainGen_228Th::Deexcitation(Int_t InicialState, Int_t & FinalState) {
	...
	if (InicialState==1){numGammas=1;}
		...
		cout << "-E- EnsarThoriumChainGen_228Th: Incorrect final state!" << endl;
	}
...
void EnsarThoriumChainGen_228Th::TrackMomentum( Double_t Energy, Double_t & Px, Double_t & Py, Double_t & Pz ) {
...
ClassImp(EnsarThoriumChainGen_228Th)
