// *********************************************************************
// *****   
// *****             EnsarUraniumChainGen_234Pa header file         
// ***** 		     
// *****  	The generator creates the 234Pa->beta + 234U* and 
// ***** 		234U*->234U+gamma reactions
...
#ifndef ENSAR_URANIUMCHAIN_234PA_H
#define ENSAR_URANIUMCHAIN_234PA_H
...
class EnsarUraniumChainGen_234Pa : public FairGenerator
{
  public:

    /** Default constructor. **/
    EnsarUraniumChainGen_234Pa();

    /** Constructor.  **/
    EnsarUraniumChainGen_234Pa(const char* inputFile);

    /** Destructor. **/
    virtual ~EnsarUraniumChainGen_234Pa();
 ...
 private:
    ...
    ClassDef(EnsarUraniumChainGen_234Pa,1);
    void CloseInput();
    void ReadParameters();
