// *********************************************************************
// *****   
// *****             EnsarActiniumChainGen_227Ac source file                                   
// *****   							
// *********************************************************************

#include "EnsarActiniumChainGen_227Ac.h"
...
// -----   Default constructor   ------------------------------------------
EnsarActiniumChainGen_227Ac::EnsarActiniumChainGen_227Ac()  :
  FairGenerator(),
...
EnsarActiniumChainGen_227Ac::EnsarActiniumChainGen_227Ac(const char* inputFile) :
  FairGenerator(),
	fPointVtxIsSet(0), fBoxVtxIsSet(0),
  fThetaRangeIsSet(0), fPhiRangeIsSet(0),
	fX(0), fY(0), fZ(0),
	...
	fPhiMin(0), fPhiMax(0)
{
  ...
  cout << "-I- EnsarActiniumChainGen_227Ac: Opening input file " << inputFile << endl;
  fFileName  = inputFile;
  
  fInputFile = new ifstream(fFileName);
  if ( ! fInputFile->is_open() ) Fatal("EnsarActiniumChainGen_227Ac","Cannot open input file.");
...
Bool_t  EnsarActiniumChainGen_227Ac::Init()
{
		
	if (fPointVtxIsSet && fBoxVtxIsSet) {
    Fatal("Init()","EnsarActiniumChainGen_227Ac: Cannot set point and box vertices simultaneously");
  }
...
// -----   Read events   --------------------------------------------------
Bool_t EnsarActiniumChainGen_227Ac::ReadEvent(FairPrimaryGenerator* primGen)
{
  
  
  //----- Check for input file -----
  if ( ! fInputFile->is_open() ) {
    cout << "-E- EnsarActiniumChainGen_227Ac: Input file not open!" << endl;
    return kFALSE;
  }
	...
	Probability_emmittedParticles [0]=0.54;
	Probability_emmittedParticles [1]=0.35;
	Probability_emmittedParticles [2]=0.1;
...
void EnsarActiniumChainGen_227Ac::CloseInput() {
  if ( fInputFile ) {
    if ( fInputFile->is_open() ) {
      cout << "-I- EnsarActiniumChainGen_227Ac: Closing input file " 
	   << fFileName << endl;
      fInputFile->close();
    }
    delete fInputFile;
...
// ---Read Parameters File --------------------------------------------
void EnsarActiniumChainGen_227Ac::ReadParameters() {

}

// --- De-excitation Process --------------------------------------------
TArrayF* EnsarActiniumChainGen_227Ac::Deexcitation(Int_t InicialState, Int_t & FinalState) {
	...
	//Excited states
	Energygammas				[1][1]=0.0000093;
	Probability					[1][1]=1.;
	NucleusFinalState		[1][1]=0;


	Energygammas				[2][1]=0.0000151;
	Probability					[2][1]=0.0215;
	NucleusFinalState		[2][1]=1;

	Energygammas				[2][2]=0.00002433;
	Probability					[2][2]=0.9785;
	...
	if (InicialState==1){numGammas=1;}
		...
		cout << "-E- EnsarActiniumChainGen_227Ac: Incorrect final state!" << endl;
	}
...
void EnsarActiniumChainGen_227Ac::TrackMomentum( Double_t Energy, Double_t & Px, Double_t & Py, Double_t & Pz ) {
...
ClassImp(EnsarActiniumChainGen_227Ac)
