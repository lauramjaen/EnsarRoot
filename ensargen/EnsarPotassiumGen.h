// *********************************************************************
// *****   
// *****             EnsarPotassiumGen file         
// ***** 		     
// *****  	The generator recreates the 40K decay:  
// ***** 			-CE: 40K+beta-> 40Ar*, 40Ar*-> 40Ar+gamma
// ***** 			-Beta: 40K-> beta+40Ca
// ***** 	
...
#ifndef ENSAR_POTASSIUMGEN_H
#define ENSAR_POTASSIUMGEN_H
...
class EnsarPotassiumGen : public FairGenerator
{
  public:
    ...
    /** Constructor.  **/
    EnsarPotassiumGen(const char* inputFile);

    /** Destructor. **/
    virtual ~EnsarPotassiumGen();
