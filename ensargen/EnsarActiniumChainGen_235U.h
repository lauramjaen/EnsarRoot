// *********************************************************************
// *****   
// *****             EnsarActiniumChainGen_235U header file         
// ***** 		     
// *****  	The generator creates the 235U->alpha + 231Th* and 
// ***** 		231Th*->231Th+gamma reactions
...
#ifndef ENSAR_ACTINIUMCHAIN_235U_H
#define ENSAR_ACTINIUMCHAIN_235U_H
...
class EnsarActiniumChainGen_235U : public FairGenerator
{
  public:

    /** Default constructor. **/
    EnsarActiniumChainGen_235U();

    /** Constructor.  **/
    EnsarActiniumChainGen_235U(const char* inputFile);

    /** Destructor. **/
    virtual ~EnsarActiniumChainGen_235U();
 ...
 private:
    ...
    ClassDef(EnsarActiniumChainGen_235U,1);
    void CloseInput();
    void ReadParameters();
