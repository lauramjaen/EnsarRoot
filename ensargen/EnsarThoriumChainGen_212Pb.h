// *********************************************************************
// *****   
// *****             EnsarThoriumChainGen_212Pb header file         
// ***** 		     
// *****  	The generator creates the 212Pb->alpha + 212Bi* and 
// ***** 		212Bi*->212Bi+gamma reactions
...
#ifndef ENSAR_THORIUMCHAIN_212PB_H
#define ENSAR_THORIUMCHAIN_212PB_H
...
class EnsarThoriumChainGen_212Pb : public FairGenerator
{
  public:

    /** Default constructor. **/
    EnsarThoriumChainGen_212Pb();

    /** Constructor.  **/
    EnsarThoriumChainGen_212Pb(const char* inputFile);

    /** Destructor. **/
    virtual ~EnsarThoriumChainGen_212Pb();
 ...
 private:
    ...
    ClassDef(EnsarThoriumChainGen_212Pb,1);
    void CloseInput();
    void ReadParameters();
