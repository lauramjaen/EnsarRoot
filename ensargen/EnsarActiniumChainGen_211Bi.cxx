// *********************************************************************
// *****   
// *****             EnsarActiniumChainGen_211Bi source file                                   
// *****   							
// *********************************************************************

#include "EnsarActiniumChainGen_211Bi.h"
...
// -----   Default constructor   ------------------------------------------
EnsarActiniumChainGen_211Bi::EnsarActiniumChainGen_211Bi()  :
  FairGenerator(),
...
EnsarActiniumChainGen_211Bi::EnsarActiniumChainGen_211Bi(const char* inputFile) :
  FairGenerator(),
	fPointVtxIsSet(0), fBoxVtxIsSet(0),
  fThetaRangeIsSet(0), fPhiRangeIsSet(0),
	fX(0), fY(0), fZ(0),
	...
	fPhiMin(0), fPhiMax(0)
{
  ...
  cout << "-I- EnsarActiniumChainGen_211Bi: Opening input file " << inputFile << endl;
  fFileName  = inputFile;
  
  fInputFile = new ifstream(fFileName);
  if ( ! fInputFile->is_open() ) Fatal("EnsarActiniumChainGen_211Bi","Cannot open input file.");
...
Bool_t  EnsarActiniumChainGen_211Bi::Init()
{
		
	if (fPointVtxIsSet && fBoxVtxIsSet) {
    Fatal("Init()","EnsarActiniumChainGen_211Bi: Cannot set point and box vertices simultaneously");
  }
...
// -----   Read events   --------------------------------------------------
Bool_t EnsarActiniumChainGen_211Bi::ReadEvent(FairPrimaryGenerator* primGen)
{
  
  
  //----- Check for input file -----
  if ( ! fInputFile->is_open() ) {
    cout << "-E- EnsarActiniumChainGen_211Bi: Input file not open!" << endl;
    return kFALSE;
  }
	...
	Probability_emmittedParticles [0]=0.8377;
	Probability_emmittedParticles [1]=0.1623;
...
void EnsarActiniumChainGen_211Bi::CloseInput() {
  if ( fInputFile ) {
    if ( fInputFile->is_open() ) {
      cout << "-I- EnsarActiniumChainGen_211Bi: Closing input file " 
	   << fFileName << endl;
      fInputFile->close();
    }
    delete fInputFile;
...
// ---Read Parameters File --------------------------------------------
void EnsarActiniumChainGen_211Bi::ReadParameters() {

}

// --- De-excitation Process --------------------------------------------
TArrayF* EnsarActiniumChainGen_211Bi::Deexcitation(Int_t InicialState, Int_t & FinalState) {
	...
	if (InicialState==1){numGammas=1;}
		...
		cout << "-E- EnsarActiniumChainGen_211Bi: Incorrect final state!" << endl;
	}
...
void EnsarActiniumChainGen_211Bi::TrackMomentum( Double_t Energy, Double_t & Px, Double_t & Py, Double_t & Pz ) {
...
ClassImp(EnsarActiniumChainGen_211Bi)
