// *********************************************************************
// *****   
// *****             EnsarThoriumChainGen_208Tl header file         
// ***** 		     
// *****  	The generator creates the 208Tl->beta + 208Pb* and 
// ***** 		208Pb*->208Pb+gamma reactions
...
#ifndef ENSAR_THORIUMCHAIN_208TL_H
#define ENSAR_THORIUMCHAIN_208TL_H
...
class EnsarThoriumChainGen_208Tl : public FairGenerator
{
  public:

    /** Default constructor. **/
    EnsarThoriumChainGen_208Tl();

    /** Constructor.  **/
    EnsarThoriumChainGen_208Tl(const char* inputFile);

    /** Destructor. **/
    virtual ~EnsarThoriumChainGen_208Tl();
 ...
 private:
    ...
    ClassDef(EnsarThoriumChainGen_208Tl,1);
    void CloseInput();
    void ReadParameters();
