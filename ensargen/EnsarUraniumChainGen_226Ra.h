// *********************************************************************
// *****   
// *****             EnsarUraniumChainGen_226Ra header file         
// ***** 		     
// *****  	The generator creates the 226Ra->alpha + 222Rn* and 
// ***** 		222Rn*->222Rn+gamma reactions
...
#ifndef ENSAR_URANIUMCHAIN_226RA_H
#define ENSAR_URANIUMCHAIN_226RA_H
...
class EnsarUraniumChainGen_226Ra : public FairGenerator
{
  public:

    /** Default constructor. **/
    EnsarUraniumChainGen_226Ra();

    /** Constructor.  **/
    EnsarUraniumChainGen_226Ra(const char* inputFile);

    /** Destructor. **/
    virtual ~EnsarUraniumChainGen_226Ra();
 ...
 private:
    ...
    ClassDef(EnsarUraniumChainGen_226Ra,1);
    void CloseInput();
    void ReadParameters();
