// *********************************************************************
// *****   
// *****             EnsarThoriumChainGen_228Ac header file         
// ***** 		     
// *****  	The generator creates the 228Ac->beta + 228Th* and 
// ***** 		228Th*->228Th+gamma reactions
...
#ifndef ENSAR_THORIUMCHAIN_228AC_H
#define ENSAR_THORIUMCHAIN_228AC_H
...
class EnsarThoriumChainGen_228Ac : public FairGenerator
{
  public:

    /** Default constructor. **/
    EnsarThoriumChainGen_228Ac();

    /** Constructor.  **/
    EnsarThoriumChainGen_228Ac(const char* inputFile);

    /** Destructor. **/
    virtual ~EnsarThoriumChainGen_228Ac();
 ...
 private:
    ...
    ClassDef(EnsarThoriumChainGen_228Ac,1);
    void CloseInput();
    void ReadParameters();
