// *********************************************************************
// *****   
// *****             EnsarThoriumChainGen_212Bi header file         
// ***** 		     
// *****  	The generator creates the 212Bi->alpha + 212Bi* and 
...
#ifndef ENSAR_THORIUMCHAIN_212BI_H
#define ENSAR_THORIUMCHAIN_212BI_H
...
class EnsarThoriumChainGen_212Bi : public FairGenerator
{
  public:

    /** Default constructor. **/
    EnsarThoriumChainGen_212Bi();

    /** Constructor.  **/
    EnsarThoriumChainGen_212Bi(const char* inputFile);

    /** Destructor. **/
    virtual ~EnsarThoriumChainGen_212Bi();
 ...
 private:
    ...
    ClassDef(EnsarThoriumChainGen_212Bi,1);
    void CloseInput();
    void ReadParameters();
