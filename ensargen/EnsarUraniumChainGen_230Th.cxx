// *********************************************************************
// *****   
// *****             EnsarUraniumChainGen_230Th source file                                   
// *****   							
// *********************************************************************

#include "EnsarUraniumChainGen_230Th.h"
...
// -----   Default constructor   ------------------------------------------
EnsarUraniumChainGen_230Th::EnsarUraniumChainGen_230Th()  :
  FairGenerator(),
...
EnsarUraniumChainGen_230Th::EnsarUraniumChainGen_230Th(const char* inputFile) :
  FairGenerator(),
	fPointVtxIsSet(0), fBoxVtxIsSet(0),
  fThetaRangeIsSet(0), fPhiRangeIsSet(0),
	fX(0), fY(0), fZ(0),
	...
	fPhiMin(0), fPhiMax(0)
{
  ...
  cout << "-I- EnsarUraniumChainGen_230Th: Opening input file " << inputFile << endl;
  fFileName  = inputFile;
  
  fInputFile = new ifstream(fFileName);
  if ( ! fInputFile->is_open() ) Fatal("EnsarUraniumChainGen_230Th","Cannot open input file.");
...
Bool_t  EnsarUraniumChainGen_230Th::Init()
{
		
	if (fPointVtxIsSet && fBoxVtxIsSet) {
    Fatal("Init()","EnsarUraniumChainGen_230Th: Cannot set point and box vertices simultaneously");
  }
...
// -----   Read events   --------------------------------------------------
Bool_t EnsarUraniumChainGen_230Th::ReadEvent(FairPrimaryGenerator* primGen)
{
  
  
  //----- Check for input file -----
  if ( ! fInputFile->is_open() ) {
    cout << "-E- EnsarUraniumChainGen_230Th: Input file not open!" << endl;
    return kFALSE;
  }
	...
	Probability_emmittedParticles [0]=0.763;
	Probability_emmittedParticles [1]=0.234;
...
void EnsarUraniumChainGen_230Th::CloseInput() {
  if ( fInputFile ) {
    if ( fInputFile->is_open() ) {
      cout << "-I- EnsarUraniumChainGen_230Th: Closing input file " 
	   << fFileName << endl;
      fInputFile->close();
    }
    delete fInputFile;
...
// ---Read Parameters File --------------------------------------------
void EnsarUraniumChainGen_230Th::ReadParameters() {

}

// --- De-excitation Process --------------------------------------------
TArrayF* EnsarUraniumChainGen_230Th::Deexcitation(Int_t InicialState, Int_t & FinalState) {
	...
	Probability					[1][1]=1.;
	Energygammas				[1][1]=0.00006767;//MeV
	...
	if (InicialState==1){numGammas=1;}
		...
		cout << "-E- EnsarUraniumChainGen_230Th: Incorrect final state!" << endl;
	}
...
void EnsarUraniumChainGen_230Th::TrackMomentum( Double_t Energy, Double_t & Px, Double_t & Py, Double_t & Pz ) {
...
ClassImp(EnsarUraniumChainGen_230Th)
