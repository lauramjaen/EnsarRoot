// *********************************************************************
// *****   
// *****             EnsarActiniumChainGen_231Th header file         
// ***** 		     
// *****  	The generator creates the 231Th->alpha + 231Pa* and 
// ***** 		231Pa*->231Pa+gamma reactions
...
#ifndef ENSAR_ACTINIUMCHAIN_231TH_H
#define ENSAR_ACTINIUMCHAIN_231TH_H
...
class EnsarActiniumChainGen_231Th : public FairGenerator
{
  public:

    /** Default constructor. **/
    EnsarActiniumChainGen_231Th();

    /** Constructor.  **/
    EnsarActiniumChainGen_231Th(const char* inputFile);

    /** Destructor. **/
    virtual ~EnsarActiniumChainGen_231Th();
 ...
 private:
    ...
    ClassDef(EnsarActiniumChainGen_231Th,1);
    void CloseInput();
    void ReadParameters();
