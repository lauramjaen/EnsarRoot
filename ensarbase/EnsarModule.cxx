...
void EnsarModule::SetRotAnglesEuler(Double_t phi, Double_t theta, Double_t psi)
{
  ...
  if ( fLocalTrans == kFALSE ){
    ...
    LOG(INFO) << "EnsarModule::SetRotAngles() is ignored ! " << FairLogger::endl;
    LOG(INFO) << "EnsarModule::SetRotAngles Local Transf. already activated ... " << FairLogger::endl;
    fLabTrans = kFALSE;
  }
}
...
void EnsarModule::SetRotAnglesXYZ(Double_t xx, Double_t yy, Double_t zz)
{
  ...
  if ( fLabTrans == kFALSE ){
    ...
    LOG(INFO) << "EnsarModule::SetRotAnglesXYZ() is ignored ! " << FairLogger::endl;
    LOG(INFO) << "EnsarModule::SetRotAngles Lab Transf. already activated ... " << FairLogger::endl;
    fLocalTrans = kFALSE;
  } 
}
