...
#ifndef E105DSSDMAPPAR_H
#define E105DSSDMAPPAR_H 1
...
class E105DSSDMapPar : public FairParGenericSet
{
  ...
  public:
    ...
    E105DSSDMapPar(const char* name, const char* title, const char* context);
