#ifndef PNDSILIDETECTORPOINT_H
#define PNDSILIDETECTORPOINT_H 1
...
class E105SiLiPoint : public FairMCPoint
{
  ...
  public:
     ...
     **/
    E105SiLiPoint(Int_t trackID, Int_t detID, TVector3 pos, TVector3 mom,
                          TVector3 posOut, TVector3 momOut, Double_t tof, Double_t length, Double_t eLoss);

    /** Destructor **/
    virtual ~E105SiLiPoint();
  ...
  private:
    ...
    /** Copy constructor **/
    E105SiLiPoint(const E105SiLiPoint&);
    E105SiLiPoint operator=(const E105SiLiPoint&);

    ClassDef(E105SiLiPoint,2)
