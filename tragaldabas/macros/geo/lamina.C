...
void lamina(const char* geoTag)
{
  ...
  TString geoFileName = geoPath + "/tragaldabas/geometry/lamina_";
...
TGeoVolume *RPC_Lead=gGeoManager->MakeBox("RPC_Lead", pLeadMedium,
  ...
  pTragaWorld->AddNode(RPC_KeepInVolume,2,new TGeoCombiTrans(0.,0.,150.,rotUni)); 
