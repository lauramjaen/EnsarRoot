...
void laminaPb(const char* geoTag)
{
  ...
  TString geoFileName = geoPath + "/tragaldabas/geometry/laminaPb_";
...
//  pTragaWorld->AddNode(RPC_Lead,0,new TGeoCombiTrans(0.,0.,0.,rotUni));
  ...
  pTragaWorld->AddNode(RPC_KeepInVolume,1,new TGeoCombiTrans(0.,0.,120.,rotUni)); 
