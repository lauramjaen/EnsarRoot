...
void bloquePb(const char* geoTag)
{
  ...
  TString geoFileName = geoPath + "/tragaldabas/geometry/bloquePb_";
...
//  pTragaWorld->AddNode(RPC_KeepInVolume,1,new TGeoCombiTrans(0.,0.,-100.,rotUni));
  ...
  pTragaWorld->AddNode(RPC_KeepInVolume,0,new TGeoCombiTrans(0.,0.,50.,rotUni));
  pTragaWorld->AddNode(RPC_KeepInVolume,1,new TGeoCombiTrans(0.,0.,30.,rotUni));
  pTragaWorld->AddNode(RPC_Lead,1,new TGeoCombiTrans(-10.,-20.,10.,rotUni));
